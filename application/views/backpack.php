...
<body>
		...
		<div class="sellitem">	
			<div class="row">
				<div class="twocolumn">
					<div id="itempic"><img src="<?php echo base_url(); ?>uploads/backpack.jpg" alt="" height="300"></div>
					<div id="itempic"><img src="<?php echo base_url(); ?>uploads/backpack1.jpg" alt="" height="300"></div>
					<div id="itempic"><img src="<?php echo base_url(); ?>uploads/backpack2.jpg" alt="" height="300"></div>
				</div>
			<div class="twocolumn">
				...
				<form method="POST" action="<?php echo base_url(); ?>index.php/backpack/cart">
					<div class="input-group">
				...
				<form method="POST" action="<?php echo base_url(); ?>index.php/backpack/review">
					<div class="input-group">
