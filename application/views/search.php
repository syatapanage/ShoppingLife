...
<body>
	...
	<div id="category">
		<h2>Search: <?php echo $searchterm; ?></h2>
	</div>
	 
	<div class="row">
	 	<form method="POST" action="<?php echo base_url(); ?>index.php/home/search">
			<?php foreach ($rowlist as $item => $list):?>
			<div class="column">
				<img src="<?php echo base_url(); ?>uploads/<?php echo $rowlist[$item]; ?>.jpg" 
					alt="Item" style="width:100%" height="270" width= "150">
				<p><?php echo $rowname[$item]; ?>: $<?php echo $rowprice[$item]; ?></p>
